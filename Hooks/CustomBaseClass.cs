...
namespace Proceso_168016__sgdetest.Hooks
{
    public static class CustomBaseClass
    {
        ...
        public static void ctrlv(this IWebElement element)
        {
        ...
        public static void CargarArchivo(this IWebElement element, string value)
        {
        ...
        public static void EnterText3(this IWebElement element, string value)
        {
        ...
        public static void EnterText2(this IWebElement element, string value)
        {
        ...
        public static void Minimizethewindow()
        {
